<?php
    ...
    $controllerCall = $_GET["controller"] ?? "utilisateur";
    $actionCall = $_GET["action"] ?? "login";

    // Création du chemin vers le controller
    $controllerName = "CCoworker\\CCoworker\\Controllers\\" . ucfirst($controllerCall) . "Controller";
