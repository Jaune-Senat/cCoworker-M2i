...
const POPUP_SUPPRIMER_ESPACE_OUI = POPUP_SUPPRIMER_ESPACE.getElementsByTagName("span")[0];
const POPUP_SUPPRIMER_ESPACE_NON = POPUP_SUPPRIMER_ESPACE.getElementsByTagName("span")[1];
...
BOUTONS_SUPPRIMER.forEach(bouton => {
    bouton.addEventListener("click", (e) => {
        POPUP_SUPPRIMER_ESPACE.style.display = "flex";
